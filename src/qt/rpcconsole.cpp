...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if(model)
    {
        ...
        ui->peerWidget->setColumnWidth(PeerTableModel::BytesSent, BYTES_COLUMN_WIDTH);
        ui->peerWidget->setColumnWidth(PeerTableModel::BytesRecv, BYTES_COLUMN_WIDTH);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Antoninianus RPC console.") + "<br>" +
