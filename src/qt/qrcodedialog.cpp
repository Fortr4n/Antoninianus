    ...
    address(addr)
{
    ...
    if (label.trimmed().isEmpty()) {
        setWindowTitle(QString("Antoninianus - Generate QR Code"));
    } else {
        setWindowTitle(QString("Antoninianus - Generate QR Code for %1").arg(label));
    }
...
{
    QString ret = QString("antoninianus:%1").arg(address);
    int paramCount = 0;
